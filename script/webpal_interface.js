...
var interface_left=200;		/* the horizontal position of the interface */
var interface_top=0;			/* the vertical position of the interface */
var interface_width=500;	/* the width of the interface */
var interface_height=300;	/* the height of the interface at maximum size */
/*
 *		These variables reflect the initial status of the interface.
 */
var interface_minimised=false;
var interface_hidden=true;
